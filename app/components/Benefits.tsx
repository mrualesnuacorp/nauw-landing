...
export default function Benefits() {
  return (
    <section id="beneficios" className="py-24 bg-[#F5F0EB]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-[#1A1A1A] leading-tight mb-6">
              ¿Qué es el
              <br />
              chocho?
            </h2>
            <p className="text-[#6B6361] leading-relaxed text-lg">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-20">
          {stats.map((s) => (
            <div key={s.label} className="bg-white rounded-3xl p-6 text-center">
              <p className="text-4xl font-bold text-[#1A1A1A] mb-1">{s.value}</p>
              <p className="text-xs text-[#6B6361] uppercase tracking-wider">{s.label}</p>
            </div>
          ))}
        </div>
        ...
        {/* Comparison table */}
        <div>
          <p className="text-xs font-medium text-[#936037] uppercase tracking-widest mb-6">
            Comparativa
          </p>
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[560px]">
              <thead>
                <tr>
                  <th className="text-left pb-4 pr-6 text-sm font-medium text-[#6B6361] w-1/2" />
                  ...
                  <th className="pb-4 px-4 text-xs font-medium text-[#6B6361] uppercase tracking-widest w-1/8">Whey</th>
                  <th className="pb-4 px-4 text-xs font-medium text-[#6B6361] uppercase tracking-widest w-1/8">Pea</th>
                  <th className="pb-4 px-4 text-xs font-medium text-[#6B6361] uppercase tracking-widest w-1/8">Soy</th>
                </tr>
              </thead>
              <tbody>
                {rows.map((row, i) => (
                  ...
                  >
                    <td className={`py-4 pr-6 pl-5 text-sm font-medium text-[#1A1A1A] ${i % 2 === 0 ? "rounded-l-2xl" : ""}`}>
                      {row.label}
                    </td>
          ...
          <p className="text-xs text-[#6B6361] mt-4">
