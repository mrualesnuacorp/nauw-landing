...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-black/5 py-12 mt-8">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            />
            <p className="text-sm text-[#6B6361] leading-relaxed max-w-xs">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-[#6B6361]">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a
                href="#"
                className="w-9 h-9 rounded-full bg-[#F5F0EB] flex items-center justify-center hover:bg-[#936037] group transition-colors duration-200 cursor-pointer"
        ...
        {/* Bottom bar */}
        <div className="border-t border-black/5 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[#6B6361]">
